    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0" style="position: fixed; width: 100%;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
        	...
        	<c:if test="${sessionScope.loginMember.m_id ne null}">
				<a class="nav-link disabled my-2 text-light" tabindex="-1" aria-disabled="true"></a>
	...
	<!-- Footer Start -->
        ...
        <footer>
        	<div style="height: 100px;">
        		<div style=" text-align: center; background-color: #f8f9fa;padding: 48px;">
        			Copyright &copy; - 영백 현수 효진
        		</div>
        	</div>
        </footer>
