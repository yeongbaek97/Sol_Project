		...
		<div class="detail_body_warp">
			...
			<div class="detail_info" align="left">
				...
				<div class="detail_info_item">
					...
					<div class="detail_info_item_value">${tourdetail.openperiod }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>체험 가능 연령</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.expagerangeleports }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>쉬는날</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.restdateleports }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>애완동물동반</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.chkpetleports }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>이용시간</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.usetimeleports }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>주차</strong>
					</div>
					<div class="detail_info_item_value"> ${tourdetail.parkingleports }</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>예약안내</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.reservation}</div>
				</div>
				<div class="detail_info_item">
					<div>
						<strong>문의 및 안내</strong>
					</div>
					<div class="detail_info_item_value">${tourdetail.infocenterleports}</div>
				</div>
